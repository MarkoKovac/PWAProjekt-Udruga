...
<head>
  ...
  <title>Admin - Uredi životinju</title>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <h2 class="text-center">Uredi životinju</h2>
          ...
          <div class="row d-flex justify-content-center">
            <div class="col-md-9">
              ...
              <?php endif; ?>
                ...
                <fieldset class="form-group">
                  <button name="update-animal" type="submit" class="btn btn-primary my-3">Dodaj životinju</button>
                </fieldset>
            </div>
          </div>
        </form>
